...
public:
    ...
    //pop sstatus.spp and sstasus.spie bits (has to be a non-inline function)
    static void popSppSpie();

    //push x3..31 registers on stack
    static void pushRegisters();

    //pop x3..31 registers on stack
    ...
    // read a2 register
    inline static uint64 r_a2();

    // write a2 register
    inline static void w_a2(uint64 val);

    // read a3 register
    inline static uint64 r_a3();

    // write a3 register
    inline static void w_a3(uint64 val);

    // read a4 register
    inline static uint64 r_a4();

    // write a4 register
    inline static void w_a4(uint64 val);
